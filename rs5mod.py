...
def do_add_mod(dest_rs5, source_rs5, source_archive, progress=progress):
	# NOTE: This version does not save the rs5 (and so on) afterwards - the
	# caller is expected to do that, possibly after adding multiple mods.
...
def do_add_one_mod(dest_rs5, source_rs5, source_archive, progress=progress):
	do_add_mod(dest_rs5, source_rs5, source_archive, progress=progress)
